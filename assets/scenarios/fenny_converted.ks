...
*ingredients_deceive
    ...
    [p]
    #
    金色に輝くボウルを混ぜながら、チョコを作るフェニー。[br]見守っていると、自然と口元が綻んでくる。
    [p]
    すると...
    [p]
    ...
    #ルリア
    え、ええーーー！！[br]ソ、ソンナ、イッタイダレガー！
    [p]
    #
    あからさまに動揺しているルリア。[br]まさかこれは...
    [p]
    [focus time="400"]
...
　　　#ルリア
    ...
    [p]
    #
    どうやら証言を聞く必要があるようだ。[br]君はルリアの証言を聞くことにした。
    [p]
...
*buy_equipment_route
    ...
    #ハウヘト
    えぇ、ここの店はポートブリーズでも特に質が良いの。[br]この店にはよく来るから、[br]何か聞きたいことがあればアドバイスできると思うわよ？
    [p]
   
    #フェニー
    団長さん！[br]ハウヘトなら色々目利きが効くかもなんだよ！[br]買い物のアドバイスしてもらおう？
    [l]
    #
    ; 選択肢
...
*equipment_ask_hauhet_end
    ...
    [chara_show name="hauhet" storage="hauhet_normal" pos="center"]
    #ハウヘト
    チョコを手作りするのね。[br]そうね、ならやはりボウルとヘラは妥協出来ないわ。
    [p]
