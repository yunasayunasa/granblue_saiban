...
*order_original_blend
    ...
    #サンダルフォン
    オリジナルブレンドだ。[br]良ければ感想を聞かせて欲しい。
    [p]

    #
    君はコーヒーを一口飲んだ。[br]芳醇な香りが口の中に広がり、[br]調和の取れた苦味と酸味が踊り出す。
    [p]
...
*answer_bitter
    ...
    #
    サンダルフォンは呟きながら、[br]考え込み始めた。
    [p]

    君はコーヒーを味わいながら、[br]もう少し寛ぐことにした。
    [p]
...
[chara_hide name="narumia"]
    [chara_show name="sandalphon" storage="sandalphon_normal" pos="center" time="300" wait="true"]
    #サンダルフォン
    口にあったのならよかった。[br]ペアリングは要るか？
    [p]
    ...ちょうどバレンタインだしな.[br]こんなものでよければ、食べてくれ。
    [p]

    #
    サンダルフォンは、その華奢な指で丁寧に、[br]ラッピングが施された包みを差し出した。
    [p]
