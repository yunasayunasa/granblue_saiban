*deck_scene_start
    ...
    #シエテ
    チョコを受け取れる世界と言っても、[br]団長ちゃんなら引く手数多でしょ？[br]ここで待っててもいいんじゃないかな？
    [p]

    それとも...、[br]１つ手合わせでもしながら暇を潰すかい？
    [l]
...
*spar_block_sword_badend
    ...
    ごめん！団長ちゃん！
    [p]
    団長ちゃんならこれぐらいなら大丈夫と思って、[br]強く打ち込みすぎちゃった！
    [p]
    本当ごめんね！
    [p]
    [chara_hide name="siete" time="200" wait="true"]
    #
    ベッドの横の時計を見ると、[br]既に0時を回っていた。
    [p]
    バレンタインは、終わったのだ。
    [p]
    BAD END
...
*spar_dodge_left
    ...
    すかさず打ち込むが、[br]シエテには容易に防がれる。
    [p]

    #シエテ
    いいね！さぁ団長ちゃんの番だ！[br]かかって来なさい！
    [p]
...
*spar_dont_attack
    ...
    #
    天星剣王の髪が蒼く染まる。[br]途方もない剣気が集まるのが分かる。
    [p]
    [chara_zoom name="siete" scale="1.4" restore="false"]

    体の震えが告げている。[br]まともに受ければ、死だと。
    [p]
    [vibrate time="300"]
...
*scold_them
    ...
    #
    肩を落とし船内に戻っていく3人を見送りながら、[br]君は静かに待つ。
    [p]
...
ロジャーに作ってもらった。
    ...
    #ガレオン
    賞賛。(この空の世界で生きる全ての命に[br]幸いあれ。無論、特異点にも。[br]これをどうぞ)
    [p]
    [chara_hide name="wamdus" time="200"]
    [chara_hide name="galleon" time="200"]
    #
    2人は綺麗なラッピングがなされた包みを差し出した。
    [l]
...
*receive_from_luoh_end
    ...
    #ルオー
    先に言っておくがね、[br]空の民の味覚は六竜である私にはわからない。
    [p]
    だか、それでもなるべくは寄せたつもりだ。
    [p]
    それ以上に、こういう催事は[br]気持ちが大事なのだろうという事も想像はつく。
    [p]
    まぁつまりは、、、
    [l]
    ハッピーバレンタイン。
...
*receive_from_wamdus_end
    ...
    #シエテ
    じゃあ、みんなでこれ食べよう！[br]十天衆チョコ！[br]まだまだたくさんあるからね！
    [p]

    #ワムデュス
    ...！食べる。[br]みんなで食べるの、楽しい。[br]特異点も、楽しい？
    [p]
...
*receive_from_galleon_end
    ...
    #ガレヲン
    密作。(昨年は先に贈り物を聞いたので、[br]今回は秘密に用意しました。)
    [p]
    期待。(喜んでくれると嬉しいのですが。)
    [p]

    #
    包みを開けると中には、[br]岩の塊のようなものが入っていた。
    [p]

    #ガレヲン
    縮尺。(ミニチュアサイズの島です。[br]もちろん、植物も、鉱物も。[br]この空の世界をそこに再現しました。)
    [p]
